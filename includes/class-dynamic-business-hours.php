...
class Dynamic_Business_Hours {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Dynamic_Business_Hours_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'DYNAMIC_BUSINESS_HOURS_VERSION' ) ) {
			$this->version = DYNAMIC_BUSINESS_HOURS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Dynamic_Business_Hours_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Dynamic_Business_Hours_Loader    Orchestrates the hooks of the plugin.
	 */
